...
def add_common_eval_args(group):
    ...
    group.add_argument('--backward-sequence-path', metavar='FILE', default='',
                       help='path(s) to backward sequence model file(s)')
    group.add_argument('--backward-prefix-data', metavar='FILE', default='')
    group.add_argument('--backward-sequence-data', metavar='FILE', default='')
    group.add_argument('--forward-prefix-path', metavar='FILE', default='',
                       help='path(s) to forward prefix model file(s).  If not set, defaults to the full forward model')
    group.add_argument('--forward-prefix-data', metavar='FILE', default='')
    group.add_argument('--prefix-inference', default='', choices=['beam','bidi','all',''])
    group.add_argument('--prefix-forward-decode', default='', choices=['beam', 'all', ''])
    group.add_argument('--prefix-bidi-lambda', type=float, default=5)
    group.add_argument('--sequence-bidi-lambda', type=float, default=5)
    group.add_argument('--prefix-beam', type=int, default=40)
    group.add_argument('--prefix-top-k', type=int, default=10)
    group.add_argument('--prefix-oracle',action='store_true')
    group.add_argument('--target-perplexity', action='store_true')
    group.add_argument('--prefix-exclude-file',type=str, default='',
                       help='path to text file with 1-per-line _indices_ of cod3s to exclude from decoding')
    group.add_argument('--prefix-exclude-n', type=int, default=10,
                       help='number of top k cod3s to exclude during decoding')
    group.add_argument('--bucket-distance',type=int,default=0,
...
def add_generation_args(parser):
    ...
    add_common_eval_args(group)
    # fmt: off
    group.add_argument('--beam', default=10, type=int, metavar='N',
                       help='beam size')
